          ...
          <li>
            <Link to='/cart' aria-label='Cart' title='Cart'>
              <div className='relative py-3'>
                ...
                <span class="absolute top-0 right-0 inline-flex items-center justify-center px-2  text-xs font-bold leading-none text-black transform translate-x-1/2 -translate-y-1/2 
                rounded-full">99</span>
              </div>
            </Link>
          </li>
          <li>
